...
#pragma config(Motor,  port1,           frontLeft,     tmotorVex393HighSpeed_HBridge, openLoop, encoderPort, I2C_2)
...
#pragma config(Motor,  port9,           backRight,     tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
